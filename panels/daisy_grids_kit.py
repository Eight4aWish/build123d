"""Sorrow panel, KIT PAGE labelling - for the video control diagram only.

Same geometry as daisy_grids.py. The four pots carry their second-page names
below them and nothing above, which is how the panel looks in the footage:
that was shot before the two-row labelling went onto the real panel.

NOT a manufacturing file. daisy_grids.py is the one that gets ordered.
"""
...
LABELS_SECONDARY = ()  # kit-mode variant: one label per pot
